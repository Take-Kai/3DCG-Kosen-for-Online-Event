...
- [PlayerScript.cs](./SDR%20SampleProject/Assets/Scripts/PlayerScript.cs) / [PlayerController.cs](./SDR%20SampleProject/Assets/Scripts/PlayerController.cs)
  - WASD移動，視点操作，プレイヤーの当たり判定．コントローラ入力にも対応．
- [ChangeCameraView.cs](./SDR%20SampleProject/Assets/Scripts/ChangeCameraView.cs)
  - 一人称/三人称視点の切り替え．
 
### 2. 軽量化
- [SceneChange.cs](./SDR%20SampleProject/Assets/Scripts/SceneChange.cs)
  - シーンの分割ロード．階ごとにシーンを分割し，階段でのキーボード操作によりロードを行うことでメモリ消費を抑える．
 
### 3. その他機能
- [DoorOpenClose.cs](./SDR%20SampleProject/Assets/Scripts/DoorOpenClose.cs) / [AutomaticDoor.cs](./SDR%20SampleProject/Assets/Scripts/AutomaticDoor.cs)
-   - プレイヤーが近づいたことを検知してドアを自動で開閉．
[Navi_map.cs](./SDR%20SampleProject/Assets/Scripts/Navi_map.cs) / [Navi_button.cs](./SDR%20SampleProject/Assets/Scripts/Navi_button.cs) / [Navi_emptyObj.cs](./SDR%20SampleProject/Assets/Scripts/Navi_emptyObj.cs) / [Navi_emptyObj_room.cs](./SDR%20SampleProject/Assets/Scripts/Navi_emptyObj_room.cs)
